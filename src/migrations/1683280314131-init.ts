...
export class Init1683280314131 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "place" ADD "weather" integer NOT NULL DEFAULT '0'`);
        ...
        await queryRunner.query(`ALTER TABLE "place" ADD "id" character varying NOT NULL DEFAULT '8ea95201-b436-4619-bc11-848d1282a0c0'`);
